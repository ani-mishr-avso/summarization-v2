...
def run_simple_expert(
    ...
    Mutates state["summary"], state["seller_insights"], state["sales_methodology_analysis"] and returns state.
    """
    ...
    state["summary"] = invoke_and_decode_json(lambda: llm.invoke(prompt))
